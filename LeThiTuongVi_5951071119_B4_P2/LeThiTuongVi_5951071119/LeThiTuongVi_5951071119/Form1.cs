...
namespace LeThiTuongVi_5951071119
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (IsValiData())
            {
                SqlCommand cmd = new SqlCommand("insert into StudentTb([Name], [FatherName], [RollNumber], [Address], [Mobile]) Values" + "(@Name, @FatherName, @RollNumber, @Address, @Mobile)", con);
        ...
        {
            DialogResult dialog =
            MessageBox.Show("Bạn có chắc muốn thoát chương trình?", "Thông báo!", MessageBoxButtons.OKCancel);
